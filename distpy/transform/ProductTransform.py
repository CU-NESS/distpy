...
class ProductTransform(Transform):
    """
    Class representing the product of transformations.
    """
    def __init__(self, first_transform, second_transform):
        """
        Initializes a new ProductTransform with the given transforms.
    ...
    def transforms(self):
        """
        Property storing the transforms which this is the product of.
        """
    ...
    def transforms(self, value):
        """
        Setter for the transforms which this is the product of.
