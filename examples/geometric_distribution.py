"""
File: examples/geometric_distribution.py
Author: Keith Tauscher
Date: 7 Aug 2017

Description: Example of using the GeometricDistribution class.
"""
import time
import numpy as np
...
distribution = GeometricDistribution(0.5)
...
pl.figure()
pl.hist(sample, bins=np.arange(-0.5, 11, 1), histtype='step',\
