"""
File: examples/jumping/locale_independent_jumping_distribution.py
Author: Keith Tauscher
Date: 22 Dec 2017

Description: Example of using the LocaleIndependentJumpingDistribution using a
             Gaussian distribution as its core.
"""
import os, time
import numpy as np
import matplotlib.pyplot as pl
from distpy import LocaleIndependentJumpingDistribution, GaussianDistribution,\
...
uvar = 0.25
distribution =\
    LocaleIndependentJumpingDistribution(GaussianDistribution(0, uvar))
